...
public class ParticleSystem_ParticleWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			new LuaMethod("New", _CreateParticleSystem_Particle),
	...
	static int _CreateParticleSystem_Particle(IntPtr L)
	{
	...
	static Type classType = typeof(ParticleSystem.Particle);
	...
	static int set_color(IntPtr L)
	{
		...
		ParticleSystem.Particle obj = (ParticleSystem.Particle)o;
		obj.color = (Color32)LuaScriptMgr.GetNetObject(L, 3, typeof(Color32));
		LuaScriptMgr.SetValueObject(L, 1, obj);
		return 0;
	}
