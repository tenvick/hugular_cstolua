...
public class HumanDescriptionWrap
{
	...
	static Type classType = typeof(HumanDescription);
	...
	static int set_human(IntPtr L)
	{
		...
		HumanDescription obj = (HumanDescription)o;
		obj.human = LuaScriptMgr.GetArrayObject<HumanBone>(L, 3);
	...
	static int set_skeleton(IntPtr L)
	{
		...
		HumanDescription obj = (HumanDescription)o;
		obj.skeleton = LuaScriptMgr.GetArrayObject<SkeletonBone>(L, 3);
		LuaScriptMgr.SetValueObject(L, 1, obj);
		return 0;
	}
