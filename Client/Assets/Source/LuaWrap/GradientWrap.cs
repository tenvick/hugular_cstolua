...
public class GradientWrap
{
	public static void Register(IntPtr L)
	{
		...
		LuaScriptMgr.RegisterLib(L, "UnityEngine.Gradient", typeof(Gradient), regs, fields, typeof(object));
	}
	...
	static Type classType = typeof(Gradient);
	...
	static int set_colorKeys(IntPtr L)
	{
		...
		obj.colorKeys = LuaScriptMgr.GetArrayObject<GradientColorKey>(L, 3);
		return 0;
	}
	...
	static int set_alphaKeys(IntPtr L)
	{
		...
		obj.alphaKeys = LuaScriptMgr.GetArrayObject<GradientAlphaKey>(L, 3);
		return 0;
	}
	...
	static int Evaluate(IntPtr L)
	{
		...
		Gradient obj = (Gradient)LuaScriptMgr.GetNetObjectSelf(L, 1, "Gradient");
