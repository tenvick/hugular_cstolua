...
public class LocationServiceWrap
{
	public static void Register(IntPtr L)
	{
		...
		LuaScriptMgr.RegisterLib(L, "UnityEngine.LocationService", typeof(LocationService), regs, fields, typeof(object));
	}
	...
	static Type classType = typeof(LocationService);
	...
	static int Start(IntPtr L)
	{
		...
		if (count == 1)
		{
			LocationService obj = (LocationService)LuaScriptMgr.GetNetObjectSelf(L, 1, "LocationService");
			obj.Start();
			return 0;
		}
		else if (count == 2)
