...
public class AnimationEventWrap
{
	...
	static Type classType = typeof(AnimationEvent);
	...
	static int get_isFiredByLegacy(IntPtr L)
	{
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name isFiredByLegacy");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index isFiredByLegacy on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.isFiredByLegacy);
		return 1;
	}
	...
	static int get_isFiredByAnimator(IntPtr L)
	{
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name isFiredByAnimator");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index isFiredByAnimator on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.isFiredByAnimator);
		return 1;
	}
	...
	static int get_animatorStateInfo(IntPtr L)
	{
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name animatorStateInfo");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index animatorStateInfo on a nil value");
			}
		}

		LuaScriptMgr.PushValue(L, obj.animatorStateInfo);
		return 1;
	}
	...
	static int get_animatorClipInfo(IntPtr L)
	{
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name animatorClipInfo");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index animatorClipInfo on a nil value");
			}
		}

		LuaScriptMgr.PushValue(L, obj.animatorClipInfo);
		return 1;
	}
	...
	static int set_objectReferenceParameter(IntPtr L)
	{
		...
		obj.objectReferenceParameter = (Object)LuaScriptMgr.GetUnityObject(L, 3, typeof(Object));
		return 0;
	}
	...
	static int set_messageOptions(IntPtr L)
	{
		...
		obj.messageOptions = (SendMessageOptions)LuaScriptMgr.GetNetObject(L, 3, typeof(SendMessageOptions));
		return 0;
	}
}
