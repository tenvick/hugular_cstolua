...
public class Physics2DWrap
{
	public static void Register(IntPtr L)
	{
		...
		LuaScriptMgr.RegisterLib(L, "UnityEngine.Physics2D", typeof(Physics2D), regs, fields, typeof(object));
	}
	...
	static Type classType = typeof(Physics2D);
	...
	static int IgnoreCollision(IntPtr L)
	{
		...
		if (count == 2)
		{
			Collider2D arg0 = (Collider2D)LuaScriptMgr.GetUnityObject(L, 1, typeof(Collider2D));
			Collider2D arg1 = (Collider2D)LuaScriptMgr.GetUnityObject(L, 2, typeof(Collider2D));
	...
	static int IsTouching(IntPtr L)
	{
		...
		Collider2D arg0 = (Collider2D)LuaScriptMgr.GetUnityObject(L, 1, typeof(Collider2D));
		Collider2D arg1 = (Collider2D)LuaScriptMgr.GetUnityObject(L, 2, typeof(Collider2D));
		bool o = Physics2D.IsTouching(arg0,arg1);
		LuaScriptMgr.Push(L, o);
		return 1;
	}
	...
	static int IsTouchingLayers(IntPtr L)
	{
		...
		{
			Collider2D arg0 = (Collider2D)LuaScriptMgr.GetUnityObject(L, 1, typeof(Collider2D));
			bool o = Physics2D.IsTouchingLayers(arg0);
			LuaScriptMgr.Push(L, o);
			return 1;
		}
		else if (count == 2)
		{
			Collider2D arg0 = (Collider2D)LuaScriptMgr.GetUnityObject(L, 1, typeof(Collider2D));
			int arg1 = (int)LuaScriptMgr.GetNumber(L, 2);
			bool o = Physics2D.IsTouchingLayers(arg0,arg1);
			LuaScriptMgr.Push(L, o);
			return 1;
		}
		else
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: Physics2D.IsTouchingLayers");
		}
