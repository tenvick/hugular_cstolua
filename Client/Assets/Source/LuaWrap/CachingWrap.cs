...
public class CachingWrap
{
	public static void Register(IntPtr L)
	{
		...
		LuaScriptMgr.RegisterLib(L, "UnityEngine.Caching", typeof(Caching), regs, fields, typeof(object));
	}
	...
	static Type classType = typeof(Caching);
	...
	static int IsVersionCached(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: Caching.IsVersionCached");
		}
	...
	static int MarkAsUsed(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: Caching.MarkAsUsed");
		}
