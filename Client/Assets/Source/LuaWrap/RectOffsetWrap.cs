...
public class RectOffsetWrap
{
	public static void Register(IntPtr L)
	{
		...
		LuaScriptMgr.RegisterLib(L, "UnityEngine.RectOffset", typeof(RectOffset), regs, fields, typeof(object));
	}
	...
	static Type classType = typeof(RectOffset);
	...
	static int Add(IntPtr L)
	{
		...
		RectOffset obj = (RectOffset)LuaScriptMgr.GetNetObjectSelf(L, 1, "RectOffset");
