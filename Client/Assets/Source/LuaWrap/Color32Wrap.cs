...
public class Color32Wrap
{
	...
	static Type classType = typeof(Color32);
	...
	static int ToString(IntPtr L)
	{
		...
		if (count == 1)
		{
			Color32 obj = (Color32)LuaScriptMgr.GetNetObjectSelf(L, 1, "Color32");
	...
	static int Lerp(IntPtr L)
	{
		...
		Color32 arg0 = (Color32)LuaScriptMgr.GetNetObject(L, 1, typeof(Color32));
		Color32 arg1 = (Color32)LuaScriptMgr.GetNetObject(L, 2, typeof(Color32));
